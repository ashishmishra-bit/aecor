...
const service = () => {
  return (
    <>
      {/* <Navbar /> */}
      {/* <div classNameName="relative bg-white overflow-hidden">
            ...
            <main classNameName="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div classNameName="sm:text-center lg:text-left">
                <h1 classNameName="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span classNameName="block xl:inline">Data to enrich your</span>{" "}
                ...
                <div classNameName="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  <div classNameName="mt-3 sm:mt-0 sm:ml-3">
                    <a
                      href="#"
                      classNameName="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-white border-purple-900 hover:bg-indigo-600 md:py-4 md:text-lg md:px-10 hover:text-white"
                    >
                      Get Started
                    </a>
                  </div>
      ...
      <div classNameName="pt-16 px-16 flex flex-col lg:flex-row">
      <div classNameName="card">
        ...
        <img src="/img/mutualFunds.png" classNameName="img"/>
      </div> 
      ...
      <div classNameName="px-16 flex flex-col lg:flex-row">
      <div classNameName="card">
                ...
                <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
                    <div className="relative p-1 flex items-center w-full space-x-4 justify-end">
                        ...
                        <a href="#" className="block relative">
                            <img alt="profil" src="/img/finkarma.png" className="mx-auto object-cover rounded-full h-10 w-10 "/>
                        </a>
