...
const Error = () => {
  return (
    ...
    <div className="w-full lg:w-1/2">
        ...
        <button className="w-full lg:w-auto my-4 border rounded-md px-1 sm:px-16 py-5 bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-opacity-50" onClick="/">Go back to Homepage</button>
    </div>
</div>
  );
};
